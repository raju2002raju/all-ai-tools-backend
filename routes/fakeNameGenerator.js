...
router.post('/fake-name-generator', async (req, res) => {
    try {
        ...
        const response = await axios.post(
            'https://api.openai.com/v1/chat/completions',
            {
                ...
                messages: [
                    ...
                    {
                        role: 'user',
                        content: `Generate ${howMany} fake ${gender} names for ${country}-speaking countries. Do not include numbers or extra information; only provide a clean list of names with their ${country} equivalents in brackets.`
                    }
                ],
                temperature: 0.7,
                max_tokens: 1000
